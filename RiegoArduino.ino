/* SISTEMA DE RIEGO AUTOMÃTICO CON SENSOR DE HUMEDAD DE SUELO, SENSOR
...
int sensorLluvia = A3;
#include <SimpleDHT.h>
// LibrerÃ­a  <SimpleDHT.h> del sensor de temperatura y humedad relativa
#include <SPI.h>
//LibrerÃ­a <SPI.h> del motor DC compatible con la minibomba de agua DC
...
//Velocidad de la minibomba de agua oscila entre 100 como mÃ­nimo y 255 como mÃ¡ximo. Yo he //elegido 255 pero ustedes pueden elegir la que estimen conveniente. A mÃ¡s velocidad, mayor //bombeo de agua
void setup() {
   dht.begin();
 // Inicializar el LCD
  lcd.init();
...
{ if( ground_humidity_value <= 50 && ldr_value < 10 && temperature < 30 && lluvValue < 15  ) {
 ...
 delay(5000);
//El motor de la bomba de agua arranca con la velocidad elegida anteriormente en el cÃ³digo
 }
 else{
